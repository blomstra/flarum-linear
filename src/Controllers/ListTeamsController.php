...
class ListTeamsController extends AbstractShowController
{
    /**
     ...
     */
    protected $client;
    public function __construct(SettingsRepositoryInterface $settings, TranslatorInterface $translator, LoggerInterface $logger, Teams $client)
    {
    ...
    public function data(ServerRequestInterface $request, Document $document)
    {
        ...
        return $this->client->getAll()->nodes;
